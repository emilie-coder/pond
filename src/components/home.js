...
import {
  faUsersLine, faMagnifyingGlassChart, faListCheck, faPaintBrush, faArrowRight, faLongArrowAltRight,
            ...
            <div className="section2_icons">
              <div className="section2_note">
                ...
                <p className="note_text">
                  <span className="note_text_title">Uniqueness of your work
                  </span>
                ...
                <FontAwesomeIcon icon={faLongArrowAltRight} id="readMoreArrow" />
              </div>
              <div className="section2_note">
                <div className="note_background_matte">
                  <div className="note_background" />
                ...
                <h3 className="note_subtitle">We will get to know you, listen to your stories, ect</h3>
                <p className="note_text">
                  <span className="note_text_title">New ways to market your music
                  </span>
              ...
              <div className="section2_note">
                ...
                <h3 className="note_subtitle">We will get to know you, listen to your stories, ect</h3>
                <p className="note_text">
                  <span className="note_text_title">The future of community engagement
                  </span>
                  NFT collectibles, including arts, tokens, and badges are the
              ...
              <div className="section2_note">
                ...
                <h3 className="note_subtitle">We will get to know you, listen to your stories, ect</h3>
                <p className="note_text">
                  <span className="note_text_title">Your work, your royalties </span>
